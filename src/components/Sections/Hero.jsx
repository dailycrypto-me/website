      ...
      <Container className="pointer-events-none inset-x-0 z-[5] flex items-center justify-center">
        ...
        <div className="flex flex-col gap-12">
          <div className="flex w-full flex-col items-center gap-8">
            ...
            Daily is an EVM-compatible proof-of-stake blockchain that utilizes PBFT and DAG consensus, among many world-first technical innovations.
            </p>
            */}
            <p className="max-w-xl text-center md:max-w-2xl md:text-lg">
              WE DESIGNED THE FUTURE FOR EVERYONE <br /> JOIN US, THE FUTURE IS NOW.
            </p>
